...
/**
 * Mixtape form base class.
 *
 * @method Mixtape getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseMixtapeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('mixtape[%s]');
